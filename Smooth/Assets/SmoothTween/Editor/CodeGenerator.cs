...
{
    [SerializeField] private MonoScript methodsScript;
    [SerializeField] private MethodGenerationData[] methodsData;
    [SerializeField] private AdditiveMethodsGenerator additiveMethodsGenerator;
    [SerializeField] private SpeedBasedMethodsGenerator speedBasedMethodsGenerator;

    [Serializable]
    internal class AdditiveMethodsGenerator
    {
        ...
        {
            if (additiveMethods.Length == 0) return null;
            string result = @"
...
";
    ...
    static string getMethodPrefix(Dependency dep)
    {
        switch (dep)
        {
            ...
            case Dependency.SMOOTH_TWEEN_EXPERIMENTAL:
