...
namespace SmoothTween
{
    ...
    public struct ShakeSettings
    {
        ...
        /// <see cref="SmoothTweenManager.defaultShakeEase"/>
        ...
        ShakeSettings(Vector3 strength, float duration, float frequency, Ease? falloffEase, AnimationCurve strengthOverTime, Ease easeBetweenShakes, float asymmetryFactor, int cycles,
            float startDelay, float endDelay, bool useUnscaledTime, bool useFixedUpdate)
        {
        ...
        public ShakeSettings(Vector3 strength, float duration = 0.5f, float frequency = defaultFrequency, bool enableFalloff = true, Ease easeBetweenShakes = Ease.Default, float asymmetryFactor = 0f,
                int cycles = 1, float startDelay = 0, float endDelay = 0, bool useUnscaledTime = SmoothTweenConfig.defaultUseUnscaledTimeForShakes, bool useFixedUpdate = false)
        ...
        public ShakeSettings(Vector3 strength, float duration, float frequency, AnimationCurve strengthOverTime, Ease easeBetweenShakes = Ease.Default, float asymmetryFactor = 0f, int cycles = 1,
            float startDelay = 0, float endDelay = 0, bool useUnscaledTime = SmoothTweenConfig.defaultUseUnscaledTimeForShakes, bool useFixedUpdate = false)
