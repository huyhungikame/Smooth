...
namespace SmoothTween
{
    public readonly partial struct Tween
    {
        ...
        public static Sequence ShakeCamera(Camera camera, float strengthFactor, float duration = 0.5f, float frequency = ShakeSettings.defaultFrequency, float startDelay = 0, float endDelay = 0,
            bool useUnscaledTime = SmoothTweenConfig.defaultUseUnscaledTimeForShakes)
        {
            ...
            if (camera.orthographic)
            {
                ...
                return ShakeLocalPosition(transform,
                        new ShakeSettings(new Vector3(orthoPosStrength, orthoPosStrength), duration, frequency, startDelay: startDelay, endDelay: endDelay, useUnscaledTime: useUnscaledTime))
                    .Group(ShakeLocalRotation(transform,
                        new ShakeSettings(new Vector3(0, 0, strengthFactor * 0.6f), duration, frequency, startDelay: startDelay, endDelay: endDelay, useUnscaledTime: useUnscaledTime)));
            }
        ...
        public static Tween ShakeLocalPosition(Transform target, Vector3 strength, float duration, float frequency = ShakeSettings.defaultFrequency, bool enableFalloff = true,
        ...
        public static Tween ShakeLocalPosition(Transform target, ShakeSettings settings)
        {
            return shake(TweenType.ShakeLocalPosition, PropType.Vector3, target, settings,
                (state, shakeVal) => { (state.unityTarget as Transform).localPosition = state.startValue.Vector3Val + shakeVal; }, _ => (_.unityTarget as Transform).localPosition.ToContainer());
        }

        public static Tween PunchLocalPosition(Transform target, Vector3 strength, float duration, float frequency = ShakeSettings.defaultFrequency, bool enableFalloff = true,
            Ease easeBetweenShakes = Ease.Default, float asymmetryFactor = 0f, int cycles = 1,
            float startDelay = 0, float endDelay = 0, bool useUnscaledTime = SmoothTweenConfig.defaultUseUnscaledTimeForShakes)
        ...
        public static Tween ShakeLocalRotation(Transform target, Vector3 strength, float duration, float frequency = ShakeSettings.defaultFrequency, bool enableFalloff = true,
            Ease easeBetweenShakes = Ease.Default, float asymmetryFactor = 0f, int cycles = 1,
            float startDelay = 0, float endDelay = 0, bool useUnscaledTime = SmoothTweenConfig.defaultUseUnscaledTimeForShakes)
        ...
        public static Tween PunchLocalRotation(Transform target, Vector3 strength, float duration, float frequency = ShakeSettings.defaultFrequency, bool enableFalloff = true,
            Ease easeBetweenShakes = Ease.Default, float asymmetryFactor = 0f, int cycles = 1,
            float startDelay = 0, float endDelay = 0, bool useUnscaledTime = SmoothTweenConfig.defaultUseUnscaledTimeForShakes)
        ...
        public static Tween ShakeScale(Transform target, Vector3 strength, float duration, float frequency = ShakeSettings.defaultFrequency, bool enableFalloff = true,
            Ease easeBetweenShakes = Ease.Default, float asymmetryFactor = 0f, int cycles = 1,
            float startDelay = 0, float endDelay = 0, bool useUnscaledTime = SmoothTweenConfig.defaultUseUnscaledTimeForShakes)
        ...
        {
            return shake(TweenType.ShakeScale, PropType.Vector3, target, settings, (state, shakeVal) => { (state.unityTarget as Transform).localScale = state.startValue.Vector3Val + shakeVal; },
                t => (t.unityTarget as Transform).localScale.ToContainer());
        }

        public static Tween PunchScale(Transform target, Vector3 strength, float duration, float frequency = ShakeSettings.defaultFrequency, bool enableFalloff = true,
            Ease easeBetweenShakes = Ease.Default, float asymmetryFactor = 0f, int cycles = 1,
            float startDelay = 0, float endDelay = 0, bool useUnscaledTime = SmoothTweenConfig.defaultUseUnscaledTimeForShakes)
        ...
        public static Tween PunchCustom<T>(T target, Vector3 startValue, ShakeSettings settings, Action<T, Vector3> onValueChange) where T : class =>
        ...
        internal struct ShakeData
        {
            ...
            internal void Setup(ShakeSettings settings)
            {
                ...
                }
                {
                    ...
                    {
                        _easeBetweenShakes = SmoothTweenManager.defaultShakeEase;
                    }
